...
export default function RecommendationsScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000', paddingHorizontal: 16, paddingTop: 40 }}>
      <Text style={{ color: '#fff', fontSize: 24, fontWeight: 'bold', marginBottom: 16 }}>🧠 Recomendaciones</Text>
      ...
      {recommendationGenerations < 2 && (
        ...
        >
          <View style={{ backgroundColor: '#333', padding: 16, borderRadius: 12, marginBottom: 8 }}>
            ...
            <TextInput
              style={{ backgroundColor: '#fff', padding: 8, borderRadius: 8, marginBottom: 12, color: '#000', minHeight: 60 }}
            ...
            <TouchableOpacity
              ...
              style={{ padding: 12, borderRadius: 8, backgroundColor: isGenerating ? '#555' : '#8b5cf6', alignItems: 'center' }}
            >
